...
public class PrincipalActivity extends AppCompatActivity {
    ...
    //Deslizar linhas do recyclerview
    public void swipe(){
        ...
        ItemTouchHelper.Callback itemTouch = new ItemTouchHelper.Callback() {
            ...
            public int getMovementFlags(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
                ...
                //Arrasta para direita e para esquerda
        ...
        //Anexar configuração do swipe no recyclerview
    ...
    public void excluirMovimentacao(final RecyclerView.ViewHolder viewHolder){
        ...
        alertDialog.setMessage("Você tem certeza que deseja realmente excluir essa movimentacao da sua conta?");
